import { prepareLeaveRequest, prepareAdminLeaveCreate, prepareLeaveUpdate, prepareLeaveDelete, prepareLocationCreate, prepareLocationDetail, prepareLocationUpdate, prepareLocationDelete, prepareLocationRooms, } from '../helpers/prep.js';
const tests = [
    {
...
export const testsByMethod = tests.reduce((acc, test) => {
